...
public class ResultadoListaImpl implements IResultadoListaService {
	...
	@Override
	public String fraseResultado(double tamanhoLado, double resultadoFinal, String poligono)
			throws FraseNaoFoiSalvaException {
		...
		try {
			...
			stingB.append(poligono).append(" de lado ").append(tamanhoLado).append(" cm e área ")
					.append(resultadoFormat).append(" cm2");
